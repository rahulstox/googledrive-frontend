  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        '3d-hover': '0 35px 60px -15px rgba(0, 0, 0, 0.6), 0 0 0 1px rgba(99, 102, 241, 0.2)',
        'glow': '0 0 40px rgba(99, 102, 241, 0.25)',
        'glow-lg': '0 0 60px rgba(99, 102, 241, 0.35)',
        'depth': '0 4px 6px -1px rgba(0,0,0,0.3), 0 2px 4px -2px rgba(0,0,0,0.2)',
        'depth-lg': '0 20px 25px -5px rgba(0,0,0,0.4), 0 8px 10px -6px rgba(0,0,0,0.3)',
      },
      animation: {
      ...
      keyframes: {
        float: {
          '0%, 100%': { transform: 'translateY(0) translateZ(0) rotateX(4deg)' },
          '50%': { transform: 'translateY(-8px) translateZ(8px) rotateX(4deg)' },
        },
        glow: {
